...
SECTION_SPECS: tuple[SectionSpec, ...] = (
    ...
    SectionSpec(
        ...
        instructions=(
            "本章固定输出两张独立 Markdown 表格：第一张是工作组表，第二张是专家库支持表。"
            "工作组表表头列必须是：工作组、牵头单位、主要职责。"
            "工作组至少包含 7 个：现场指挥组、综合协调组、抢险处置组、医疗救护组、后勤保障组、信息发布组、专家组。"
            "字段名称不能改写。"
            "如证据包中有专家信息，在工作组表后追加标题 **专家库支持**，并紧跟一张独立 Markdown 表格。"
            "专家库支持表表头列必须固定为：专家姓名、所在单位、专业方向、联系电话、建议支持方式。"
            "严禁把专家写成 '-' 项目符号列表、普通段落，或混进工作组表。"
            "每位专家一行；联系电话必须填写（来自证据包中专家记录的 phone 字段），不能省略或留空，缺失时写'电话待确认'。"
            "标题就是'**专家库支持**'四个字，禁止加任何来源说明，如'依据 search_experts 候选名单'/'根据专家检索结果'等措辞都不要写。"
            "本章只保留工作组表 + 专家库支持表，不要其他子表。"
        ),
        example=(
            "### 三、应急组织机构\n"
            "\n"
            ...
            "**专家库支持**：\n"
            "\n"
            "| 专家姓名 | 所在单位 | 专业方向 | 联系电话 | 建议支持方式 |\n"
            "| --- | --- | --- | --- | --- |\n"
            "| 廖俊锋 | 广西交通安全研究中心 | 应急管理、安全管理 | 13900100001 | 建议由指挥部办公室或值班人员人工联系，参与远程会商或现场技术支持 |\n"
            "| 郑屈 | 广西交通安全研究中心 | 安全应急管理 | 13900100002 | 建议由指挥部办公室或值班人员人工联系，参与技术支持 |\n"
            "| 林静 | 南宁轨道交通集团有限责任公司 | 轨道交通安全质量监管 | 13900100003 | 建议由指挥部办公室或值班人员人工联系，参与技术支持 |\n"
        ),
    ),
    SectionSpec(
